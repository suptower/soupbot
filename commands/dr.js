...
module.exports = {
	...
	execute(message, args) {
        ...
        './deutschrap/billigereime.mp3','./deutschrap/binisses.mp3','./deutschrap/blasenmann.mp3','./deutschrap/bogota.mp3','./deutschrap/boneztochter','./deutschrap/brruzi.mp3','./deutschrap/brudervertraunicht.mp3','./deutschrap/buntstiftverloren.mp3',
        ...
        './deutschrap/weihnachtsmann.mp3','./deutschrap/wieduundich.mp3','./deutschrap/wozuphysik.mp3','./deutschrap/zdfneo.mp3','./deutschrap/zeckenbiss.mp3','./deutschrap/zehnmetermalvier.mp3','./deutschrap/zumiesereime.mp3'];
